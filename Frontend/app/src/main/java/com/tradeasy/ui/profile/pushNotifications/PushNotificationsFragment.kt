 ...
 * Use the [PushNotificationsFragment.newInstance] factory method to
...
class PushNotificationsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PushNotificationsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PushNotificationsFragment().apply {
